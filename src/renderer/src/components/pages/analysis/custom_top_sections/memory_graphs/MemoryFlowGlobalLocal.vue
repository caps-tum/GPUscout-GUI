<template>
    <MemoryGraph :vertical-nodes="2" :horizontal-nodes="5" title="Memory graph" hint="hint">
        <MemoryGraphNodeLarge> Kernel </MemoryGraphNodeLarge>
        <MemoryGraphArrows :arrows="2">
            <template #arrow-1-top>
                {{ formatNumber(analysisData.getMetric(ANALYSIS.register_spilling.metrics.global_loads_count)) + ' Inst.' }}
            </template>
